<template>
  <div class="mt-8 flex">
    ...
    <div v-if="searchResult.length !=0" class="absolute mt-12 ml-2 rounded bg-gray-900 w-64">
      <ul class="mt-3">
    ...
    <img src="@/assets/images/prof.png" alt="" class="w-8 mr-4" />
  </div>
</template>
  ...
  methods: {
    ...
    async fetchSearch(term) {
        ...
        try {
          ...
          const response = await this.axios.get("https://api.themoviedb.org/3/search/movie?api_key=c6dd21371d5119b5f6b49b5b09c58fff&query=" + term
        );
